...
import 'package:goalsappdatabase/layouts/main_layout/components/goal_item.dart';
import 'package:goalsappdatabase/layouts/main_layout/cubit/main_cubit.dart';
                                          ...
                                          style: ButtonStyle(
                                              backgroundColor:
                                                  MaterialStateProperty.all(
                                                      Colors.red)),
                                          onPressed: () {
                                            MainCubit.get(context).inserData(
